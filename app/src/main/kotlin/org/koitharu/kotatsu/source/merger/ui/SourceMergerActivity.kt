package org.koitharu.kotatsu.source.merger.ui
...
import org.koitharu.kotatsu.alternatives.ui.MangaAlternativeModel
import org.koitharu.kotatsu.alternatives.ui.alternativeAD
...
@AndroidEntryPoint
class SourceMergerActivity : BaseActivity<ActivityAlternativesBinding>(),
	...
	private val viewModel by viewModels<SourceMergerViewModel>()
	...
	override fun onCreate(savedInstanceState: Bundle?) {
		...
		supportActionBar?.run {
			...
			title = getString(R.string.source_merger)
		...
		viewModel.onMerged.observeEvent(this) {
			Toast.makeText(this, R.string.source_merger_completed, Toast.LENGTH_SHORT).show()
	...
	override fun onItemClick(item: MangaAlternativeModel, view: View) {
		when (view.id) {
			...
			R.id.button_migrate -> viewModel.merge(item.manga)
